...
// console.log('here')
// require('./drives/track').track()
// base on motors TYPE
// => change motor/drive mounts

// combine motor type, motor counts/ positions/oritentations

function getParameterDefinitions ({previousParameterValues}) {
  return [
    {
      name: 'chassisDims',
      type: 'choice',
    ...
    { name: 'chShowConnectorFront', type: 'checkbox', checked: false, caption: 'Show front connector:' },
    { name: 'chConnectorsFrontCount', type: 'int', default: 2, min: 1, max: 10 },
    ...
    { name: 'chShowElectronicsHolder', type: 'checkbox', checked: true, caption: 'Show electronics holder'},
